...
class AppConstants {
  static const String APP_NAME = 'Keeggi Vendor App';
  static const double APP_VERSION = 1.4;


  static const String BASE_URL = 'https://eastern.keeggi.in';
  ...
  static const String TEMPORARILY_STORE_CLOSED='/api/close_store.php';
